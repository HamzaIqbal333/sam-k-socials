...
function SelectTrigger({ className, size = "default", children, ...props }) {
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex h-11 w-full items-center justify-between gap-2 rounded-md border-2 border-input bg-card px-3.5 py-2 text-sm text-foreground outline-none data-[placeholder]:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 data-[size=sm]:h-9",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] overflow-hidden rounded-md border-2 border-foreground bg-popover text-popover-foreground shadow-md",
